...
# 
# A total of 10 features was used as using too many features may cloud the result. By taking 10, we will have a balance between using the best features as well as capture the overall data picture
...
# 
# This validation was proceeded with the following steps. 
...
# 
# Wrt to this project, 0.67 precision means that the POI identified was correct 67% times while 0.5 recall value means the 50% of the POI returned are relevant.
...
dataset = data_dict
joblib.dump(dataset, 'my_dataset.pkl')

joblib.dump(features, 'my_feature_list.pkl')
